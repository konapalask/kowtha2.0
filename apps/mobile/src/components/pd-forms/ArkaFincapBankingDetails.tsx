...
const ArkaFincapBankingDetails: React.FC<BankingDetailsProps> = ({
  onSubmit,
  ...
  const {
    ...
    defaultValues: {
      ...
      licMutualFunds: initialData?.licMutualFunds || '',
    ...
    return (
      <View key={index} style={styles.bankAccountContainer}>
        ...
        <InputFormItem
          data={{
            title: 'Account',
            key: `bankAccounts.${index}.account`,
            control,
            errors,
            required: true,
        ...
        <InputFormItem
          data={{
            ...
            key: `bankAccounts.${index}.averageBalance`,
            control,
            errors,
            required: true,
        ...
        <InputFormItem
          data={{
            ...
            key: `bankAccounts.${index}.numberOfYearsMaintained`,
            control,
            errors,
            required: true,
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      {/* <Text style={styles.sectionTitle}>LIC/Mutual Funds</Text> */}
      ...
      <TextAreaFormItem
        data={{
          ...
          required: true,
          placeholder:
            'Describe LIC policies, mutual fund investments, and other financial instruments...',
        }}
      />
      ...
      <TextAreaFormItem
        data={{
          ...
          required: true,
          placeholder:
            'Describe all assets including property, vehicles, equipment, and other valuable items...',
        }}
      />
...
export default ArkaFincapBankingDetails;
