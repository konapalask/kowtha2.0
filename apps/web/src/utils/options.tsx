...
export const pdBankOptions = [
  ...
  { value: "Indiashelter - Salaried", label: "Indiashelter - Salaried" },
  ...
  { value: "Hero Salaried", label: "Hero Salaried" },
  { value: "DCB", label: "DCB" },
  ...
  { value: "Jana Bank above 50 alkhs", label: "Jana Bank above 50 alkhs" },
