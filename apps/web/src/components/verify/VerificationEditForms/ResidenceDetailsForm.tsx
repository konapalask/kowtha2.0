    ...
    <>
      <Col span={6}>
        <Form.Item
          ...
          rules={[
            { required: true, message: "Please select residence status" },
          ]}
        >
          <Select>
      ...
      {residenceType === "Others" && (
        <Col span={6}>
          <Form.Item
            ...
            rules={[
              { required: true, message: "Please specify residence type" },
            ]}
          >
            <Input />
          </Form.Item>
      ...
      <Col span={8}>
        <Form.Item
          ...
          rules={[
            { required: true, message: "Please select standard of living" },
          ]}
        >
          <Select>
      ...
      <Col span={6}>
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please enter years at current address",
            },
          ]}
        >
      ...
      {/* <Col span={6}>
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please select if nameboard is visible",
            },
          ]}
        >
          <Select>
      ...
      <Col span={6}>
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please select if political symbol is visible",
            },
          ]}
        >
          <Select>
