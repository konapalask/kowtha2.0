    ...
    <div class="template-content">
      ...
      <table style="${tableStyle}">
       ...
       <tr>
        ...
        <td style="${valueCellStyle}">${financialDetails.grossProfitMargin.ay202425}%</td>
        <td style="${valueCellStyle}">${financialDetails.grossProfitMargin.ay202324}%</td>
       ...
       <tr>
        ...
        <td style="${valueCellStyle}">${financialDetails.netProfitMargin.ay202425}%</td>
        <td style="${valueCellStyle}">${financialDetails.netProfitMargin.ay202324}%</td>
       ...
       <tr>
        ...
        <td style="${valueCellStyle}">${financialDetails.filledDate.ay202425}</td>
        <td style="${valueCellStyle}">${financialDetails.filledDate.ay202324}</td>
