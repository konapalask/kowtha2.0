    ...
    sections: [
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    initiatedAddress: { type: "string", title: "Initiated Address" , ui: { widget: "textarea", rows: 3 } },
                    visitedAddress: { type: "string", title: "Visited Address" , ui: { widget: "textarea", rows: 3 } },
                },
            },
        },

        {
            ...
            schema: {
                ...
                properties: {
                    ...
                    applicantDateOfBirth: { type: "string", title: "Date of Birth", format: "date" },
                    coApplicantName: { type: "string", title: "Co-Applicant" },
                    coApplicantDateOfBirth: { type: "string", title: "Date of Birth", format: "date" },
                },
            },
        },
        {
        ...
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    nameOfFirm: { type: "string", title: "Name of Firm (employer/business)" },
                },
            },
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    designation: { type: "string", title: "Designation of Borrower/ownership type of business" },
                },
            },
        },
        {
        ...
        
        {
            ...
            label: "Employment/ Business Details & Stability Business premises details",
            schema: {
                type: "object",
                properties: {
                    employmentDetails: { type: "string", title: "Employment/ Business Details" },
                    businessPremises: { type: "string", title: "Stability Business premises details" },
                },
            },
        },
        ...
        {
            id: "jobProfile",
            label: "Business Profile /Employment job profile along with previous business/employment details",
            schema: {
                type: "object",
                properties: {
                    businessOrEmploymentProfile: { type: "string", title: "Business Profile /Employment job profile" },
                    previousBusinessOrEmploymentDetails: { type: "string", title: "Previous business/employment details" },
                },
            },
        },
        ...
        },
        {
            ...
            schema: {
                ...
                properties: {
                    ...
                    salaryPerMonthPerEmployee: { type: "number", title: "Salary per month per employee" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    ...
                    wagesPerMonthOrDay: { type: "number", title: "Wages per month/per day" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    modeOfSalaryPayment: { type: "string", title: "Mode of Salary Payment" , enum: ["Cash", "Bank credit", "Other"] },
                    last3MonthSalary: { type: "number", title: "Last 3 Month Salary" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    netSalaryAsPerSalarySlipOrCertificate: { type: "number", title: "Net Salary as per salary slip/ certificate" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    netSalaryAsPeBankCredits: { type: "number", title: "Net Salary as per bank credits" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    dateOfCredit: { type: "string", title: "Date of Credit" , format: "date" },
                },
            },
        },

        {
            ...
            schema: {
                ...
                properties: {
                    ...
                    incomeAmount: { type: "number", title: "Amount" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
...

        {
            ...
            label: "Specific for Cash Salaried Profile (To be filled in for Cash Salaried profile)",
            schema: {
                type: "object",
                properties: {
                    ...
                    howManyMonthsReflectingInAttendance: { type: "number", title: "for how many months (try to check last 6 months attendance register)" },

                    attendanceReferenceChecksinSameFirm:{
                        type: "array",
                        title: "If no, then do reference checks for employment confirmation with other employees working in the same firm. Minimum 2 references to be obtain. (Name & mobile number of the reference people to be documented)",
                        items: {
                            type: "object",
                            properties: {
                    ...
                    attendanceNeighboursReferenceChecks: {
                        type: "array",
                        title: "Neighbour two reference checks to confirm applicant’s employer information is correct. (name & contact number along with feedback to be documented)",
                        items: {
                            type: "object",
                            properties: {
                    ...
                    proofOfSalaryMaintenance: {
                        type: "string",
                        title: "Does the employer maintain any salary register or any salary paid receipt/voucher or any other documentary proof for salary being paid to the borrower (Y/N) If yes, verify the salary paid to the borrower and capture photos in the PD report",
                        enum: ["Yes", "No"] 
                    },

                    salaryReferenceCheckInSameFirm: {
                        type: "array",
                        title: "If no, then do reference checks with other employees working in the same firm for salary confirmation. Minimum 2 references to be obtained. (Name & mobile number of the reference people to be documented).",
                        items: {
                            type: "object",
                            properties: {
                    ...
                    variationInSalary: {
                        type: "string",
                        title: "Any variation in the salary paid amount as per salary certificate & as per salary register verified during the visit.",
                        enum: ["Yes", "No"] 
                    },
                    employeHasGSTNumber: {
                        type: "string",
        ...
        
        {
            ...
            schema: {
                type: "object",
                properties: {
                    endUseOfProducts: { type: "string", title: "End Use of Business / Products" },
                },
            },
        },

        {
            ...
            schema: {
                type: "object",
                properties: {
                    noOfFixedClients: { type: "number", title: "No of Fixed Clients" },
                    creditPeriod: { type: "number", title: "Credit Period" },
                    cashChequeProportion: { type: "number", title: "Cash - Cheque proportion" },
                    top3customers:{
                        type: "array",
                        ...
                        items: {
                            type: "object",
                            properties: {
                                nameOfClient: { type: "string", title: "Name (top 3 customers)" },
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    noOfFixedVendor: { type: "number", title: "No of Fixed Vendor" },
                    creditPeriod: { type: "number", title: "Credit Period" },
                    cashChequeProportion: { type: "number", title: "Cash - Cheque proportion" },
                    top3vendors:{
                        type: "array",
        ...
        },
        {
            ...
            label: "Specific for Contractor Profile (To be filled in for Contractor (Resi cum office) profile:-)",
            schema: {
                type: "object",
                properties: {
                    contractsCompleted: { type: "string", title: "How many contracts completed in last 6 months" },
                    modeOfPayment: { type: "string", title: "In what mode, payment is getting against these contracts." },
                    clientDetails: {
                        type: "object",
                    ...
                    clientReferenceCheck: {
                        type: "array",
                        title: "Randomly call 2 to 3 clients to verify the contract details and document the feedback in the PD report along with details of the client called for confirmation.",
                        items: {
                            type: "object",
                            properties: {
                    ...
                    neighbourReferenceCheck: {
                        type: "array",
                        title: "Neighbour reference checks (minimum 2 people) details with name & contact details to be captured in the PD report",
                        items: {
                            type: "object",
                            properties: {
                                nameOfNeighbour: { type: "string", title: "Name of the neighbour" },
        ...
        },
        {
            ...
            schema: {
                ...
                items: {
                    type: "object",
                    properties: {
                        observations: { type: "string", title: "Observations" , ui: { widget: "textarea", rows: 3 } },
                    },
                },
            },
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    collateralAddress: { type: "string", title: "Collateral Address" , ui: { widget: "textarea", rows: 3 } },
                    areaInSqYards: { type: "number", title: "Area in Sq. Yards" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    agreementValue: { type: "number", title: "Agreement Value (in Lakhs)" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    actualPurchaseCost: { type: "number", title: "Actual Purchase Cost (in Lakhs)" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    marketValue: { type: "number", title: "Market Value (in Lakhs)" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    ocrValue: { type: "number", title: "OCR (in Lakhs)" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    ocrPaidTillDate: { type: "number", title: "OCR paid till date (in Lakhs)" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
...

        {
            ...
            schema: {
                ...
                properties: {
                    ...
                    hlPlotAndConstruction: { type: "string", title: "HL Plot + Construction" },
                    hlWorkingCapital: { type: "string", title: "HL Working Capital" },
                    assetAcquisition: { type: "string", title: "Asset Acquisition and Expansion" },
                    marketDevelopment: { type: "string", title: "Market Development and growth" },
                    debtManagement: { type: "string", title: "Debt Management and Financial Efficiency" },
        ...
        {
            id: "assetDetails",
            label: "Other Asset Details (Including properties, vehicles, investments etc.)",
            schema: {
                type: "object",
                properties: {
                    assetDetails: { type: "string", title: "Asset Details", ui: { widget: "textarea", rows: 3 } },
                    propertiesValue: { 
                        type: "number", 
                        title: "Properties (Flat, Individual House, Commercial, Agri land, vacant residential land, etc.)",},
                    lifeInsurance:{
                        type: "number",
            ...
            schema: {
                ...
                items: {
                    ...
                    properties: {
                        ...
                        loanAmount: { type: "number", title: "Loan Amount (in Lakhs)" , formatter: {
                            useIndianFormat: true,
                            locale: "en-IN",
                            maxDecimalPlaces: 2,
                            minDecimalPlaces: 0,
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    loanAmountRequired: { type: "number", title: "Loan Amount Required (in Lakhs)" , formatter: {
                        useIndianFormat: true,
                        locale: "en-IN",
                        maxDecimalPlaces: 2,
                        minDecimalPlaces: 0,
                    }, },
                    endUseDetailsOfLoan: { type: "string", title: "End Use of Loan (Amount & Detailed End Use" , ui: { widget: "textarea", rows: 3 } },
                },
            },
        },
        {
        ...
        },
        {
            ...
            schema: {
                ...
                items: {
                    type: "object",
                    properties: {
                        documentCategory: { type: "string", title: "Document Category" , enum: ["KYC Documents", "Business Ownership Documents","Income & Expense Documents", "Other Documents"]},
        ...
        },
        {
            ...
            label: "Interviewer’s Comments along with the explanations to credit comments (with brief summary report)",
            schema: {
                type: "object",
                properties: {
                    comforts: { type: "string", title: "Comforts" , ui: { widget: "textarea", rows: 3 } },
                    discomforts: { type: "string", title: "Discomforts" , ui: { widget: "textarea", rows: 3 } },
                },
            },
        },
        {
        ...
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    status: { type: "string", title: "Status" , enum: ["Positive", "Negative", "Refer"] },
                },
            },
        },
        {
            ...
            schema: {
                ...
                properties: {
                    ...
                    dateAndTimeOfInterview: { type: "string", title: "Visit Date and Time" , format: "datetime" },
                },
            },
        }
