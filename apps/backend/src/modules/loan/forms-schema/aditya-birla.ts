  ...
  sections: [
    financialsSchema,
    {
      ...
      schema: {
        ...
        properties: {
          ...
          dateOfVisit: { type: "date", title: "Date of Visit" },
          timeOfVisit: { type: "time", title: "Time of Visit" },
        },
      },
    },
    {
    ...
    },
    {
      ...
      schema: {
        type: "object",
        properties: {
          monthlySales: { type: "number", title: "Sales" },
          monthlyPurchase: { type: "number", title:"Purchase" },
          rent: { type: "number", title: "Rent" },
          salariesWages: { type: "number", title: "Salaries/ wages" },
          transportCharges: { type: "number", title: "Transport charges" },
          electricityBill: { type: "number", title: "Electricity bill" },
          otherExpenses: { type: "number", title: "Other expenses" },
          totalExpenses: { type: "number", title: "Total expenses" },
          netProfit: { type: "number", title: "Net profit" },
