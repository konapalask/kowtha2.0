    ...
    sections: [
        ...
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    aboutTheBusiness: { type: "string", title: "About the Business" , ui: {
                        widget: "textarea",
                        rows: 3,
                    }, },
                },
                ...
                properties: {
                    annualReceipts: { 
                        ...
                        title: "Annual Receipts",
                         properties: { 
                                ay202425: { type: "number", title: "AY 2024-25" , formatter: {
                                    useIndianFormat: true,
                                    locale: "en-IN",
                                    maxDecimalPlaces: 2,
                                    minDecimalPlaces: 0,
                                }, },
                                ay202324: { type: "number", title: "AY 2023-24" , formatter: {
                                    useIndianFormat: true,
                                    locale: "en-IN",
                                    maxDecimalPlaces: 2,
                                    minDecimalPlaces: 0,
...

        {
            ...
            schema: {
                    type: "object",
                    properties: {
                        noOfFixedSuppliers: { type: "number", title: "No of Fixed Suppliers" },
                        ...
                        top3suppliers:{
                            ...
                            items: {
                                type: "object",
                                properties: {
                                    nameOfSupplier: { type: "string", title: "Name (top 3 suppliers)" },
        ...
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    noOfFixedCustomers: { type: "number", title: "No of Fixed Customers" },
                    creditPeriod: { type: "number", title: "Credit Period" },
                    cashChequeProportion: { type: "number", title: "Cash - Cheque proportion" },
                    top3customers:{
                        type: "array",
        ...
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                        turnover: { type: "number", title: "Turnover" , formatter: {
                            useIndianFormat: true,
                            locale: "en-IN",
                            maxDecimalPlaces: 2,
                            minDecimalPlaces: 0,
                        }, },
                        margins: { type: "number", title: "Margins" , formatter: {
                            useIndianFormat: true,
                            locale: "en-IN",
                            maxDecimalPlaces: 2,
                            minDecimalPlaces: 0,
        ...
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    otherMajorExpensesAndBasis: { type: "string", title: "Other Major Expenses & Basis" , ui: { widget: "textarea", rows: 3 } },
                },
            },
        },
        {
            ...
            schema: {
                ...
                properties: {
                    assets: {
                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                assetAreaMeasured: { type: "string", title: "Area measured (Sq.ft)" },
                                assetPurchaseCost: { type: "number", title: "Purchase cost (in Lakhs)" , formatter: {
                            useIndianFormat: true,
                            locale: "en-IN",
                            maxDecimalPlaces: 2,
                            minDecimalPlaces: 0,
                    ...
                    liquidMoveableAssets: { type: "string", title: "Any Liquid, Moveable & Monetary items such as Cash, Gold, FD, RD, Mutual Funds, Shares, Bonds, Securities" , ui: { widget: "textarea", rows: 3 } },
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    endUseOfLoan: { type: "string", title: "End Use of Loan" , ui: { widget: "textarea", rows: 3 } },
                },
            },
        },

        {
            ...
            schema: {
                type: "object",
                properties: {
                    addressofSecurity: { type: "string", title: "Address" , ui: { widget: "textarea", rows: 3 } },
                    detailsOfSecurity: {
                        type: "array",
                        ...
                        items: {
                            ...
                            properties: {
                                ...
                                purchaseCost: { type: "number", title: "Actual Purchase Cost (in Lakhs)" , formatter: {
                                    useIndianFormat: true,
                                    locale: "en-IN",
                                    maxDecimalPlaces: 2,
                                    minDecimalPlaces: 0,
                                ...
                                ocrPaidTillDate: { type: "number", title: "OCR paid till date (in Lakhs)"},                 
