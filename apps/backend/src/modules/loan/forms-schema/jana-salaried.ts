    ...
    sections: [
        ...
        },
        {
            ...
            schema: {
                    ...
                    properties: {
                        ...
                        purchaseYear: { type: "string", title: "Purchase Year / Rent Agreement Period" },
                        purchaseCost: { type: "number", title: "Purchase Cost / Rent per month" },
                        currentMarketValue: { type: "number", title: "Current Market Value / Security Deposit" },
                        ownerRelationship: { type: "string", title: "Owner / Landlord (Relationship with Applicant)" },
        ...
        
        {
            ...
            schema: {
                type: "object",
                properties: {
                    applicantJobProfile: { type: "string", title: "Applicant's Job Profile" , ui: { widget: "textarea", rows: 3 } },
                    aboutTheCompany: { type: "string", title: "About the company" , ui: { widget: "textarea", rows: 3 } },
                    previousEmploymentDetails: { type: "string", title: "Previous Employment" , ui: { widget: "textarea", rows: 3 } },
                    spouseJobProfile: { type: "string", title: "Spouse's Job Profile" , ui: { widget: "textarea", rows: 3 } },
        ...
        },
        {
            ...
            schema: {
                ...
                properties: {
                    ...
                    liquidMoveableAssets: { type: "string", title: "Any Liquid, Moveable & Monetary items such as Cash, Gold, FD, RD, Mutual Fund Holdings, Shares, Bonds, Securities -" , ui: { widget: "textarea", rows: 3 } },
                    insurances: { type: "string", title: "Life Insurance, Mediclaim, Property/Asset Insurance (Premium & Sum Assured) -" , ui: { widget: "textarea", rows: 3 } },
                    capitalInvestedBusiness: { type: "string", title: "Capital Invested in any Business, Loans & Advances given -" , ui: { widget: "textarea", rows: 3 } },
                    vehicles: { type: "string", title: "Car, Bike and Other Vehicles (Company Name and Model) -" , ui: { widget: "textarea", rows: 3 } },
                },
            },
        },
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    existingRelationship: { type: "string", title: "Existing Relationship with Jana Small Finance Bank Ltd.", ui: { widget: "textarea", rows: 3 } },
                },
            },
        },
        ...
        },
        {
            ...
            schema: {
                type: "object",
                properties: {
                    creditCardDetails: { type: "string", title: "Credit Card Details" , ui: { widget: "textarea", rows: 3 } },
                },
            },
        },
        {
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    address: { type: "string", title: "Address" , ui: { widget: "textarea", rows: 3 } },
                    securityDetails: { 
                        type: "array", 
                        ...
                        items: { type: "object",
                             properties: { 
                                ...
                                purchaseCost: { type: "number", title: "ActualPurchase Cost (in Lakhs)" , formatter: {
                                    useIndianFormat: true,
                                    locale: "en-IN",
                                    maxDecimalPlaces: 2,
                                }, },
                                ...
                                ocrValue: { type: "string", title: "OCR (in Lakhs)" , formatter: {
                                    useIndianFormat: true,
                                    locale: "en-IN",
                                    maxDecimalPlaces: 2,
                                }, },
...

        {
            ...
            schema: {
                type: "object",
                properties: {
                    caseStrengths: { type: "string", title: "Case Strengths" , ui: { widget: "textarea", rows: 3 } },
                    caseWeakness: { type: "string", title: "Case Weakness" , ui: { widget: "textarea", rows: 3 } },
                    pdStatus: { type: "string", title: "PD Status" , enum: ["Positive", "Negative", "Credit Refer"] },
                    nameOfAgencyExecutive: { type: "string", title: "Name of Agency Executive" },
                    dateOfVisit: { type: "string", title: "Date of Visit" , format: "date" },
