      ...
      "schema": {
        ...
        "properties": {
          ...
          "neighborhoodShopsNature": {
            "type": "string",
            "title": "Nature/Types of Neighborhood Shops (E.g. General Store, Jewelry Store, Hardware Store, etc.)"
          },
          "digitalWalletUsed": {
            "type": "string",
            "title": "Digital wallet used in the business? (E.g. PhonePe, Paytm, GooglePay, AmazonPay, JIO Money, Yono SBI, Airtel Money, Etc.)"
          },
          "customerShopLocality": {
            "type": "string",
            "title": "Customer Shop/Office Locality (Slum/Market Road/Main Road/Highway)",
            "enum": [
              "Slum",
              "Market Road",
              "Main Road",
          ...
          "utilityBillDetails": {
            "type": "string",
            "title": "Utility bill (Clear Photo to be Taken) last 2 months & present month units consumption to be written"
          },
