    ...
    },
    {
      ...
      "schema": {
        ...
        "properties": {
          ...
          "gstRegistration": {
            "type": "string",
            "title": "Whether Business was Registered under GST - Yes/No If Yes then mention GST Number",
            "enum": [
              "Yes",
              "No"
            ]
      ...
      "schema": {
        ...
        "properties": {
          ...
          "neighborCheckThirdParty": {
            "type": "string",
            "title": "Details of neighbor check / Third party check done and status"
          }
        }
      },
      "required": true
