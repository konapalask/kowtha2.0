  ...
  sections: [
    {
      ...
      schema: {
        ...
        required: ["loanAccountNo", "nameOfCustomer"],
      },
      required: true,
    },
    {
    ...
    },
    {
      ...
      label:
        "Details of partners, directors, shareholders (with family background)",
      schema: {
        type: "object",
        properties: {
          ...
          localityDetailsCompetitorsOverallProspectOfLocationAnyNegativeFeedback:
            {
              type: "string",
              title:
                "Locality details (competitors, overall prospect of location, any negative feedback)",
            },
        },
      },
      required: true,
      ...
      schema: {
        ...
        properties: {
          ...
          typeOfPropertyReadyPlotSelfConstructionUnderConstructionVacant: {
            type: "string",
            title:
              "Type of property (Ready/Plot/Self Construction/Under Construction/Vacant)",
          },
      ...
      schema: {
        ...
        properties: {
          ...
          customerInvestmentHabitsMonthlySavingsFdPropertyEtc: {
            type: "string",
            title:
              "Customer investment habits (monthly savings, FD, property, etc.)",
          },
          ...
          proposedEndUseOfPropertySelfOccupationInvestmentForHlCases: {
            type: "string",
            title:
              "Proposed end use of property (Self-occupation/Investment) for HL cases",
          },
      ...
      schema: {
        ...
        properties: {
          ...
          endUseOfFundsForPastLoansBlPlLapInLast3Years: {
            type: "string",
            title:
              "End use of funds for past loans (BL/PL/LAP in last 3 years)",
          },
          exceptionalBorrowingInLast12MonthsExactUseAndImpactOnTheBusinessRevenue:
            {
              type: "string",
              title:
                "Exceptional borrowing in last 12 months (exact use and impact on the business revenue)",
            },
      ...
      schema: {
        ...
        properties: {
          ...
          tpcThirdPartyCheckMinimum1Neighbour1LocalIndependentParty: {
            type: "string",
            title:
              "TPC (Third Party Check) – minimum 1 neighbour + 1 local independent party",
          },
          ...
          verificationOfQrCodesLicensesPermitsNameBoardContactNumberBelongingToEmployer:
            {
              type: "string",
              title:
                "Verification of QR codes, licenses, permits, name board, contact number (belonging to employer)",
              pattern: "^[0-9]{10}$",
            },
          googleCheckAnyNegativeObservationsFeedbackDedupeMatch: {
            type: "string",
            title:
              "Google check & any negative observations/feedback/dedupe match",
          },
          statusOfTheCase: {
            type: "string",
